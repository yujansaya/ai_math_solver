...
def math_chatbot():
    ...
    repl_tool = Tool(
        name="Repl",
        func=repl.run,
        description="A useful tool for executing the Python code. Useful to solve complex math questions. Could be combined with reasoning.",
    )

    agent = initialize_agent(
        tools=[wikipedia_tool, math_tool, word_problem_tool, repl_tool],
        llm=llm,
